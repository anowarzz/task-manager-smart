      ...
      <span className="text-myPink">Smart</span> Task Manager
          ...
          <div class="md:hidden">
            <button
              ...
              title="Open Menu"
              class="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline bg-blue-500"
                  ...
                  <div class="flex items-center justify-between mb-4 text-white">
                    ...
                    <div>
                      <button
                        ...
                        title="Close Menu"
                        class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline bg-blue-500"
