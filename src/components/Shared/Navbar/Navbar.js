                    ...
                    <div class="flex items-center justify-between mb-4 text-white">
                      ...
                      <div>
                        <button
                          ...
                          title="Close Menu"
                          class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline bg-white"
                      ...
                      <ul class="space-y-4">
                        <li>
                          <Link
                            ...
                            class="font-medium tracking-wide transition-colors duration-200 hover:text-deep-purple-accent-400 text-white"
                          >
                            Add Task
                          </Link>
                        </li>
